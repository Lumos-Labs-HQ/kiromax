...
// Open opens a SQLite DB and ensures the kmax_meta table exists.
...
// GetMeta returns the value for key from kmax_meta, or "" if not found.
...
// SetMeta upserts a key/value pair in kmax_meta.
